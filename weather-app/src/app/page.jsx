    ...
    <div className="bg-green-700 h-screen">
      <div className="bg-[#F3F4F6] h-[1200px] w-[1600px] flex justify-between mx-auto ">
        <div className="bg-[#F3F4F6] h-[1200px] w-[800px] relative">
          <DayCard />
          <div className="z-10 w-[200px] h-[200px] bg-yellow-500 rounded-[100%] absolute left-[700px] top-[500px] flex">
            <img
          ...
          <div className="ml-20 flex px-4 py-3 rounded-md border-2 border-blue-500 overflow-hidden max-w-md mx-auto font-[sans-serif]">
            <svg
